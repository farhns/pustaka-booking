<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <a href="<?= base_url('laporan/laporan_data_anggota_pdf'); ?>" class="btn btn-warning mb-3"><i class="far fa-file-pdf"></i> Download Pdf</a>
      <a href="<?= base_url('laporan/export_excel_laporan_anggota'); ?>" class="btn btn-success mb-3"><i class="far fa-file-excel"></i> Export ke Excel</a>
